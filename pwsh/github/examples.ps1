...
$repos = Get-GitHubRepos -Org "gtvfx-contrib" -Limit 10
...
$team = Get-GitHubTeam -Team "envoy-internal-dev" -Org "gtvfx-contrib"
if ($team) {
...
# $result = Add-GitHubTeamToRepos -Team "envoy-internal-dev" -Permission "push" -Repos $specificRepos -Org "gtvfx-contrib"
Write-Host ""
...
# Uncomment to actually run:
# $result = Add-GitHubTeamToRepos -Team "envoy-internal-dev" -Permission "push" -Org "gtvfx-contrib" -Limit 500
Write-Host ""
...
$allRepos = Get-GitHubRepos -Org "gtvfx-contrib" -Limit 100
...
#     $result = Add-GitHubTeamToRepos -Team "public_maintainers" -Permission "maintain" -Repos $publicRepos.name -Org "gtvfx-contrib"
# }
Write-Host ""
...
# Uncomment to actually run:
# $result = Remove-GitHubTeamFromRepos -Team "old_team" -Repos @("repo1", "repo2") -Org "gtvfx-contrib"
Write-Host ""
...
Write-Host "Would add 'envoy-internal-dev' to the bypass list of 'Main Branch Protections' ruleset" -ForegroundColor Green
# Uncomment to actually run:
# $result = Add-GitHubTeamToRulesetBypassList -Team "envoy-internal-dev" -RulesetName "Main Branch Protections" -Repos $rulesetRepos -Org "gtvfx-contrib"
# To bypass only on PRs (not direct pushes):
# $result = Add-GitHubTeamToRulesetBypassList -Team "envoy-internal-dev" -RulesetName "Main Branch Protections" -Repos $rulesetRepos -BypassMode "pull_request"
Write-Host ""
