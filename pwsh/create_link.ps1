...
.DESCRIPTION
    ...
    Example (auto-path):
        Target : V:\repo\gt\contrib\unreal_qt\py\unreal_qt
        CWD    : V:\some\place
        Link   : V:\some\place\unreal_qt -> <Target>
...
.EXAMPLE
    ...
    .\create_link.ps1 -Target V:\repo\gt\contrib\unreal_qt\py\unreal_qt

.EXAMPLE
    # Provide an explicit link path
    .\create_link.ps1 -Target V:\repo\gt\contrib\unreal_qt\py\unreal_qt -Path C:\links\unreal_qt
#>
param(
