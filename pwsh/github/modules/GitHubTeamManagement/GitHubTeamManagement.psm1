...
function Get-GitHubTeam {
    ...
    .EXAMPLE
        Get-GitHubTeam -Team "envoy-internal-dev"
...
function Find-GitHubReposByCodeowner {
    ...
    .EXAMPLE
        Find-GitHubReposByCodeowner -Owner "@gtvfx-contrib/envoy-internal-dev"
...
function Add-GitHubTeamToBranchProtection {
    ...
    .EXAMPLE
        Add-GitHubTeamToBranchProtection -Team "envoy-internal-dev"
...
function Add-GitHubTeamToRulesetBypassList {
    ...
    .EXAMPLE
        Add-GitHubTeamToRulesetBypassList -Team "envoy-internal-dev" -RulesetName "Main Branch Protections"
